...
public class UniqueVertexCountStep extends UniqueElementCountStep {
    ...
    void registerElement(Element element) {
        if (element instanceof Vertex) {
            UniqueVertexCounter.registerVertex(stepInstance, (Vertex) element);
        }
    }

    public String toString() {
        return "UniqueVertexCountStep(" + stepInstance + ')';
    }
}
